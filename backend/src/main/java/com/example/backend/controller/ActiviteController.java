...
public class ActiviteController {
   ...
   ActiviteService activiteService;
    ...
    public Activite ajouterActivite(@RequestBody Activite activite){
        return this.activiteService.ajouterActivite(activite);
    ...
    //SUPPRIMER ACTIVITE
 	...
 	@ApiResponse(code = 404, message = "aucune activité avec cet id n'existe dans la BDD") })
    public void supprimerActiviteById(@PathVariable ("Id_activite") long Id_activite){
         this.activiteService.supprimerActiviteById(Id_activite);
     }
     //activite par anne
